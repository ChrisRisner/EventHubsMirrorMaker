...
CONSUMER_CONFIG="bootstrap.servers=52.186.65.205:31090\nrequest.timeout.ms=60000\ngroup.id=example-mirrormaker-group\nexclude.internal.topics=true\nsasl.mechanism=PLAIN\nsecurity.protocol=SASL_SSL\nsasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required username=\"\$ConnectionString\" password=\"52.186.65.205:31090\";"
